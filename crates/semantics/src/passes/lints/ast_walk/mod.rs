...
use checks::{
    ...
    check_manual_ok_err, check_manual_ok_or, check_manual_replace_all, check_manual_time_since,
    ...
    check_match_on_bool, check_match_single_binding, check_needless_match, check_negated_equality,
