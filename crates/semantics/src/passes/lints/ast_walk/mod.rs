...
use checks::{
    ...
    check_manual_map, check_manual_time_since, check_manual_time_until, check_manual_unwrap_or,
    ...
    check_redundant_pattern_matching, check_redundant_sprintf, check_replaceable_with_zero_fill,
