...
use checks::{
    ...
    check_needless_question_mark, check_needless_update, check_neg_multiply,
    check_negated_equality, check_negated_logical_operand, check_non_negative_comparison,
    check_or_fn_call, check_out_of_domain_value, check_pattern_naming, check_redundant_closure,
    check_redundant_closure_call, check_redundant_comparison, check_redundant_else,
    check_redundant_field_names, check_redundant_guards, check_redundant_operation,
