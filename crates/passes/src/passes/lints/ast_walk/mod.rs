...
use checks::{
    ...
    check_needless_question_mark, check_negated_equality, check_negated_logical_operand,
    ...
    check_redundant_else, check_redundant_operation, check_redundant_pattern_matching,
